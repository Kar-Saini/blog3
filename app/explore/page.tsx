...
const Explore = () => {
  ...
  const filteredBlogs =
    activeTab === "premium"
      ? sampleBlogs.filter((blog) => blog.isPremium)
      : sampleBlogs;
    ...
    <div className="font-sans">
      ...
      <section className="py-14 px-4 ">
        <div className="max-w-7xl mx-auto hover:cursor-pointer">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 transition hover:shadow-xl duration-300">
              ...
              <div className="md:w-2/3 p-6 md:p-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href={`/blog/${featuredBlog.id}`}>Read More</a>
                  </Button>
                </div>
              </div>
            </div>
